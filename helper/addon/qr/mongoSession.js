...
const useMongoDBAuthState = async (config) => {
  ...
  const readData = async (dataKey) => {
    try {
      ...
      logger.error(`Error reading data for ${dataKey}:`, error.message);
      return null;
    }
  };
  ...
  const writeData = async (dataKey, value) => {
    try {
      ...
      logger.error(`Error writing data for ${dataKey}:`, error.message);
      throw error;
    }
  };
  ...
  const bulkWrite = async (operations) => {
    try {
      ...
      logger.error(`Error in bulk write:`, error.message);
      throw error;
    }
  };
  ...
  const removeData = async (dataKey) => {
    try {
      ...
      logger.error(`Error removing data for ${dataKey}:`, error.message);
      throw error;
    }
  };
  ...
  const clearAll = async () => {
    try {
      ...
      logger.error("Error clearing session data:", error.message);
      throw error;
    }
  };
  ...
  const removeAll = async () => {
    try {
      ...
      logger.error("Error removing all session data:", error.message);
      throw error;
    }
  };
